({
    ...
    var deliverable= component.get("v.deliverableRecord");    
        ...
        var newTaskObject = {
            ...
            'Completion_Date__c':'',
            'Status__c':'',
            'Deliverables__c': deliverable.Id,
            'Priority__c' : '', 
            'Billable__c': ''
        };
        ...
        //taskInstance.Deliverables__c =  component.get("v.recordId");    
    },    
    ...
    create_Task_ObjectData : function(component, event) { 
        var newTaskObject = {
            ...
            'Completion_Date__c':'',
            'Status__c':'',
            'Deliverables__c': component.get("v.recordId"),
            'Priority__c' : '',
            'Id': ''            
        };
        component.set("v.task_Instance", newTaskObject);
    ...
    setTaskFormat:function(component, event){
    var taskInstance = component.get("v.task_Instance");
    
    if(taskInstance.Project__c[0].length > 1)    
    taskInstance.Project__c = taskInstance.Project__c[0];

    if(taskInstance.Deliverables__c[0].length > 1)    
    taskInstance.Deliverables__c = taskInstance.Deliverables__c[0];
    ...
    validate:function(component, event){	
        ...
        for(var indexVar=0; indexVar < allTaskAssignmentRows.length; indexVar++){
            if(taskId  && taskId.substring(0,3) === 'a2R'){
       ...
       if((allTaskAssignmentRows[indexVar].Task__c === '' && allTaskAssignmentRows[indexVar].Project_Resource__c === '') ||
        ...
        console.log(':TaskAsignment: ', pulled);    
        return isValid;
    },
    ...
    for(var indexVar=0; indexVar < deleteTaskAssignmentRows.length; indexVar++){
        console.log(indexVar+'::Delete Row-validate_DeleteList:  ', deleteTaskAssignmentRows[indexVar]); 
        ...
        action.setCallback(this, function(response){
            ...
            if(state === 'SUCCESS'){
                ...
                if(wrapper_insertRTA && wrapper_insertRTA.upsertMessage){
                   ...
                   component.set("v.recordId", wrapper_insertRTA.taskId);
                }
                ...
                action2.setCallback(this, function(response){
                   ...
                   this.showSuccessToast_Delete(component,event);    
                    ...
                    this.create_TaskAssignment_DeleteData(component, event);
                            ...
                            action5.setParams({
                                taskId : wrapper_insertRTA.taskId
                            }); 
                            action5.setCallback(this, function(response){
                                ...
                                if(wrapper_insertRTA && wrapper_insertRTA.taskId){
                                   ...
                                   // component.set("v.TaskAssignmentList", component.get("v.TaskAssignmentList"));    
                                    }
                                    
                                   
                                   
                            //Set Task Id
                        if(component.find("taskForm"))
                        component.find("taskForm").set("v.recordId", wrapper_insertRTA.taskId); 
                                   
                        component.set("v.recordId", wrapper_insertRTA.taskId);    
                        taskInstance.Id= wrapper_insertRTA.taskId;
                        component.set("v.task_Instance", taskInstance);    
    ...
    setTaskInstance:function(component, event){
        ...
        */
        ...
        /*    
            ...
            component.find("task_Deliverable").set("v.value", selectedTask.Deliverables__c);    
            */
