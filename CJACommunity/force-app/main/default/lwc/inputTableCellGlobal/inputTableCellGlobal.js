...
import apexSearch from '@salesforce/apex/LookupController.deliverable_search';
...
export default class InputTableCell extends LightningElement {
    ...
    setup(){
        ...
        if(this.type=='lookup' && this.value !=null){
            ...
            console.log('this.type ==> ' + this.type +  '---this.value ==> '  + this.value)
    ...
    checkIfError(){
        ...
        var inputs = this.template.querySelectorAll('.taskvalidation');
